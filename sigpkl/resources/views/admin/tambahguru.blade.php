        ...
        <div class="card-body">
              ...
              <form action="{{ route('store_guru') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_guru" name="nama_guru"
                    placeholder="Masukkan Nama Anda ..." value="{{ old('nama_guru') }}">
            ...
            <div class="col col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="email_guru" name="email_guru"
                  placeholder="Masukkan Email Anda ..." value="{{ old('email_guru') }}">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="n_wa_guru" name="n_wa_guru"
                  placeholder="Masukkan No HP Anda ..." value="{{ old('n_wa_guru') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="alamat_guru" name="alamat_guru"
              placeholder="Masukkan Alamat Anda ..." value="{{ old('alamat_guru') }}">
